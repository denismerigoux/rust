...
use back::write::{self, with_llvm_pmb, save_temp_bitcode, get_llvm_opt_level,
    new_diagnostic_handlers};
    ...
    -> Result<Vec<LtoModuleCodegen<LlvmCodegenBackend>>, FatalError>
{
    ...
    let mut serialized_bitcode = Vec::new();
    {
        ...
        let _handler = new_diagnostic_handlers(cgcx, diag_handler, llcx);
